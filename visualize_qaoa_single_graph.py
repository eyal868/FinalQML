...
# Data source
INPUT_CSV = 'outputs/spectral_gap/spectral_gap_3reg_N12_res20.csv'
...
def visualize_qaoa(graph_info: Dict):
    ...
    if SAVE_FIGURE:
        ...
        # Desktop mirror copy
        try:
            _, desktop_dir = get_run_dirs("qaoa_demo", timestamp=True)
            save_file(filename, "qaoa_demo", _desktop_dir=desktop_dir)
            save_run_info(desktop_dir, "qaoa_demo", extra_info={"graph_id": graph_info.get('graph_id')})
