...
"""
=========================================================================
Spectral Gap Analysis for Random 3-Regular Graphs (FIXED VERSION)
=========================================================================
IMPORTANT FIX: Handles ground state degeneracy properly!

For Max-Cut, the ground state can be degenerate due to symmetry.
The spectral gap is defined as the energy difference between the ground
state and the first NON-DEGENERATE excited state.

This is crucial at s=1 where bit-flip symmetry causes degeneracy.
=========================================================================
"""
...
# Output filename
OUTPUT_FILENAME = f'Delta_min_3_regular_N{N_QUBITS}_{NUM_GRAPHS}graphs_FIXED.csv'
...
def main():
    ...
    print("=" * 70)
    print("  AQC SPECTRAL GAP ANALYSIS (DEGENERACY-AWARE)")
    print("=" * 70)
    print(f"\n📊 Configuration:")
