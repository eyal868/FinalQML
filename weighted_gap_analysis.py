...
CONFIG = {
    # Input data
    'input_csv': 'outputs/qaoa_unweighted/N12/qaoa_sweep_N12_p1to10_filtered.csv',
    ...
    # Output
    'output_csv': 'outputs/qaoa_weighted/N12/weighted_gap_analysis_N12.csv',
...
def main():
    ...
    # Desktop mirror copy
    try:
        _, desktop_dir = get_run_dirs("weighted_gap_analysis", timestamp=True)
        save_file(CONFIG['output_csv'], "weighted_gap_analysis", _desktop_dir=desktop_dir)
        save_run_info(desktop_dir, "weighted_gap_analysis", extra_info={"config": {k: str(v) for k, v in CONFIG.items()}})
