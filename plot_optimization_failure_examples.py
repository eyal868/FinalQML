...
def main():
    ...
    # Desktop mirror copy
    try:
        _, desktop_dir = get_run_dirs("optimization_failures", timestamp=True)
        save_file(OUTPUT_FILE, "optimization_failures", _desktop_dir=desktop_dir)
        save_run_info(desktop_dir, "optimization_failures")
