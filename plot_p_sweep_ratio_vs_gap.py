...
DEFAULT_INPUT = 'outputs/exploratory/weighted_qaoa_pipeline/weighted_qaoa_N12_p1to5.csv'
...
def plot_ratio_vs_gap(input_csv: str, output_dir: str = None, show_plot: bool = False) -> str:
    ...
    # Desktop mirror copy
    try:
        _, desktop_dir = get_run_dirs("ratio_vs_gap", timestamp=True)
        save_file(output_file, "ratio_vs_gap", _desktop_dir=desktop_dir)
        save_run_info(desktop_dir, "ratio_vs_gap", extra_info={"input_csv": input_csv})
...
if __name__ == "__main__":
    ...
    if not os.path.exists(input_csv):
        ...
        print(f"     - outputs/qaoa_unweighted/N12/qaoa_sweep_N12_p1to10_deg2.csv")
        sys.exit(1)
